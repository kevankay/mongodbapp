...
public class ProductController {
	...
	public ResponseEntity<List<Product>> findByProductByRange(@RequestParam String productCategory, double min,
			double max) throws ProductNotFoundException {
		return new ResponseEntity<List<Product>>(productService.findByProductByRange(productCategory, min, max),
				HttpStatus.OK);
	}
